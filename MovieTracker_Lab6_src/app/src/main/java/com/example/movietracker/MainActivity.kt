...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // Константы для SharedPreferences (тема)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        // Применяем сохранённую тему ПЕРЕД setContentView
        applySavedTheme()
        ...
        initViews()
        findViewById<Button>(R.id.buttonToggleTheme).setOnClickListener {
            toggleDarkMode()
        }
        setupRecyclerView()
    ...
    fun toggleDarkMode() {
        ...
        recreate() // Перезапускаем Activity
    }
